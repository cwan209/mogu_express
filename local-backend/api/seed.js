...
const products = [
  { _id: 'prod_101', tuanId: 'tuan_001', title: '澳洲本地有机西兰花',
    ...
    categoryIds: ['cat_fresh'], section: '蔬菜', price: 599, stock: 50, sold: 12, sort: 1, participantCount: 8,
  ...
  { _id: 'prod_102', tuanId: 'tuan_001', title: '塔斯马尼亚蓝莓',
    ...
    categoryIds: ['cat_fresh'], section: '浆果', price: 899, stock: 30, sold: 18, sort: 2, participantCount: 14,
    createdAt: iso(-3 * DAY), updatedAt: iso(-1 * HOUR) },
